...
def bebop(category, for_sale, records):
    ...
    for _ in range(records):
        ...
        listing_mapping['creator'] = 'seanslipetz@gmail.com'
...
cats = [random.randint(1,16) for _ in range(2000)]

for cat in cats:
    bebop(CATEGORIES[cat], 'sell', random.randint(1,40))
    bebop(CATEGORIES[cat], 'want', random.randint(1,40))
